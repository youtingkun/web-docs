...
export function MarkdownTransform() {
  return {
    ...
    async transform(code, id) {
      ...
      console.log(chalk.blue("element-plus-md-transform-code", code));
      console.log(chalk.red("element-plus-md-transform-id", id));

      const componentId = path.basename(id, ".md");
      console.log(
        chalk.red("element-plus-md-transform-componentId", componentId)
      );
      const append = {
        headers: [],
        footers: [],
      ...
      console.log(chalk.red("element-plus-md-transform-code", code));
...
const transformComponentMarkdown = (id, componentId, code, append) => {
